  ...
  <div class="post-index">
    ...
    <header class="pt-5 border-bottom bg-light">
      <div class="container pt-md-1 pb-md-1">
        ...
        <p class="bd-lead">Kontak SMK Nabil Pintar.</p>
      </div>
    </header>
        ...
        <div class="col-md-5">
          <div class="card border-0 shadow-sm rounded">
            <div class="card-body">
              ...
              <hr />
              <p>
                <i class="fa fa-map-marker" aria-hidden="true"></i> Jl.Abdul
                Wahab Syahranie Gang Pandan Mekar dalam 2 no 158 rt 34
              </p>
              <p><i class="fas fa-phone"></i> +62857-8585-2224</p>
              <p><i class="fas fa-envelope"></i> info@smkindonesia.sch.id</p>
            </div>
          </div>
        </div>
      </div>
